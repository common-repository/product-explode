                    ...
                    foreach ($childProducts as $key => $value) {
                        ...
                        <tr id="<?php echo "tr_product_id_" . $key ?>">
                            ...
                            <td class="label-area-size">
                                <input type="text" class="label_width" data-lableid="<?php echo $i; ?>"
                                    name="<?php echo "pe_label_field_" . $i . "_width"; ?>"
                                    id="<?php echo "pe_label_field_" . $i . "_width"; ?>" value="<?php echo $labelWidth; ?>"> X
                                <input type="text" class="label_height" data-lableid="<?php echo $i; ?>"
                                    name="<?php echo "pe_label_field_" . $i . "_height"; ?>"
                                    id="<?php echo "pe_label_field_" . $i . "_height"; ?>" value="<?php echo $labelHeight; ?>">
                            </td>
                            <td class="label-num">
                                <input type="text" class="label-field-link-to-num" name="<?php echo "label_text_" . $i ?>"
                                    id="label_field_link_to_num" value="<?php echo $labelText; ?>">
                            </td>
                        </tr>
                        <?php
